...
public class LikeRepositoryTest {
	...
	Users liker1, liker2, liker3;

	@BeforeEach
	void setUp() {
		postWriter = Users.builder().username("Post Writer").password("1234").email("post@writer").build();
		...
		liker1 = Users.builder().username("Liker 1").password("1234").email("liker1@domain").build();
		userRepository.save(liker1);
		liker2 = Users.builder().username("Liker 2").password("1234").email("liker2@domain").build();
		userRepository.save(liker2);
		liker3 = Users.builder().username("Liker 3").password("1234").email("liker3@domain").build();
	...
	void findByPost_IdTest_should_return_likes_list() {
		...
		Like like1 = new Like(liker1, post1);
		Like like2 = new Like(liker2, post1);
		Like like3 = new Like(liker3, post1);
	...
	void existsByUser_IdAndPost_Id_should_return_true_when_like_exists_and_false_when_not() {
		...
		Like like = new Like(liker1, post1);
	...
	void countByPost_IdTest_should_return_like_count() {
		...
		Like like2 = new Like(liker2, post1);
		Like like3 = new Like(liker3, post1);
		Like like4 = new Like(liker1, post2);
		Like like5 = new Like(liker2, post2);
		Like like6 = new Like(liker3, post3);
