...
public enum ErrorCode {
    ...
    AUTH_ACCOUNT_LOCKED        (HttpStatus.UNAUTHORIZED, "AUTH_007", "잠긴 계정입니다."),
    AUTH_ACCOUNT_DISABLED      (HttpStatus.UNAUTHORIZED, "AUTH_008", "비활성화된 계정입니다."),
    AUTH_CREDENTIALS_EXPIRED   (HttpStatus.UNAUTHORIZED, "AUTH_009", "비밀번호가 만료된 계정입니다."),

    /* ========== USER (도메인) ========== */
    USER_NOT_FOUND             (HttpStatus.NOT_FOUND,    "USER_001", "해당 사용자가 존재하지 않습니다."),
    USER_COMMENT_NOT_FOUND     (HttpStatus.NOT_FOUND,    "USER_002", "댓글을 찾을 수 없습니다."),
    USER_DUPLICATE_EMAIL       (HttpStatus.CONFLICT,     "USER_003", "이미 사용 중인 이메일입니다."),
    USER_DUPLICATE_USERNAME    (HttpStatus.CONFLICT,     "USER_004", "이미 사용 중인 사용자 이름입니다."),
    ...
    USER_VALIDATION_GENERIC    (HttpStatus.BAD_REQUEST,  "USER_199", "잘못된 사용자 입력입니다."),
    ...
    INTERNAL_SERVER_ERROR      (HttpStatus.INTERNAL_SERVER_ERROR, "SYS_999",  "서버 오류가 발생했습니다.");
