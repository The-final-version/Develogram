...
public class FollowDto {
	...
	public FollowDto(Long id, UserEntity follower, UserEntity followed, LocalDateTime createdAt, String followerName,
		...
		this.followerProfileimg = follower.getProfileEntity().getImgUrl();    // 팔로우 하는 유저 프로필 이미지
		this.followedProfileImg = followed.getProfileEntity().getImgUrl();    // 팔로우 받는 유저 프로필 이미지
	}
